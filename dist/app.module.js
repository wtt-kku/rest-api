...
const config_service_1 = require("./environment/config.service");
...
AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([products_entity_1.ProductEntity, computer_entity_1.ComputerEntity]),
        ],
